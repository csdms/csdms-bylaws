...
\subsubsection{Nomination/Election, Term}

The members of ExCom (Working Group and Focus Research Group Chairs) are elected or appointed as described in Article IV, Sections 2.6 and 3.3, and shall serve 3-year terms.  They are eligible for re-appointment (by majority approval of the Executive Committee). Members of ExCom other than the chair of the Steering Committee may not simultaneously serve on the Steering Committee.  
...
Any Officer (Executive Director, Deputy Director, Steering Committee Chair and Working/Focus Research Group Chairs) may be removed at any time with cause (see CSDMS Code of Conduct on CSDMS Website) by a 2/3rds majority vote of the Executive Committee.
...
\subsubsection{Focus Research Group Chair Nomination/Election}
Focus Research Group Chairs are nominated by mutual agreement between the sponsoring organization and the CSDMS Executive Director. The FRG members will then have the opportunity to vote yes or no for the nominee (simple majority election).  FRG Chairs shall serve a term of 3 years and shall be eligible for re-election.
